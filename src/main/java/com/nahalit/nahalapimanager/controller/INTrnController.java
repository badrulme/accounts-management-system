...
public class INTrnController {
    ...
    @DeleteMapping("/trndtls")
    public ResponseEntity<Map> deleAllTrnDtl(@RequestParam Long trnNo) {
        return new ResponseEntity<>(this.inTrnService.deleteAllTrnDtl(trnNo), HttpStatus.OK);
    }
