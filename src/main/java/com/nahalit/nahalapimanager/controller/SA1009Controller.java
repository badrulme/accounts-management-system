...
public class SA1009Controller {
    ...
    public ResponseEntity<List<SaRegion>> saveRegionList(@RequestBody List<SaRegion> saRegions) {
    ...
    public ResponseEntity<Map> deleteRegion(@RequestParam Long regionNo) throws ResourceNotFoundException {
    ...
    public ResponseEntity<List<SaSubregion>> getAllSaSubregion(@RequestParam Long regionNo) {
