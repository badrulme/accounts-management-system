...
public class RL1001Service {
    ...
    @Autowired
    public RL1001Service(RlFacingRepository rlFacingRepository, RlRoadSizeRepository rlRoadSizeRepository, InUomRepository inUomRepository, AuthService authService) {
