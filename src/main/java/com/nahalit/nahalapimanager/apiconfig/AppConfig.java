...
public class AppConfig {
    ...
    public static String[] NONFILTERRING_PATH_PATTERNS =new String[]{"/core/auth/**",",/csrf", "/v2/api-docs", "/swagger-resources/configuration/ui", "/configuration/ui", "/swagger-resources", "/swagger-resources/configuration/security", "/configuration/security", "/swagger-ui.html", "/webjars/**"};
