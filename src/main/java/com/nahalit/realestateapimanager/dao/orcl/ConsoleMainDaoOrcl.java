...
import com.nahalit.realestateapimanager.dao.ConsoleMainDao;
...
@Repository
public class ConsoleMainDaoOrcl implements ConsoleMainDao {
  private final NamedParameterJdbcTemplate db;

  public ConsoleMainDaoOrcl(NamedParameterJdbcTemplate _db) {
    this.db = _db;
  }
